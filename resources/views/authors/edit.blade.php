...
@section('content')
    <div class="max-w-2xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Edit Author</h2>
            ...
            <form action="{{ route('authors.update', $author->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $author->email)" required />
